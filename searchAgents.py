...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        pos, visitedCorners = state[0], state[1]
        sumCorners = sum(visitedCorners)
        
        isGoal = sumCorners == 3 and pos in self.corners and visitedCorners[self.corners.index(pos)] == 0
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            x,y = state[0]
            localCorners = list(state[1])
            if (x,y) in self.corners:
                localCorners[self.corners.index((x,y))] = 1
            ...
            if not hitsWall:
                ...
                successors.append( (((nextx, nexty), tuple(localCorners)), action, cost))
...
class FoodSearchProblem:
    ...
    def addToCache(self, strCoord, dist):
        self.cachedDist[strCoord] = dist
        
    def getCacheVal(self, strCoord):
        return self.cachedDist.get(strCoord)
